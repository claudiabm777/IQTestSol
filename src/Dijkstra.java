...
public class Dijkstra
{
    ...
    public static List<Vertex> example(List<Tablero>nodos,String nombreOrigen,String nombreDestino)
    {
    	...
    	for(Arco arc:nodos.get(i).adj){
			...
			Edge e=new Edge(buscar(vertices,arc.hijo.nombre),arc.costo);
